...
def add_customer(num):
    ...
    buy_type = ['买', '卖', '租']  # 买卖意向
    intent_city = ['深圳市']  # 意向城市
    intent_area = ['南山区', '福田区', '宝安区']  # 意向区域
    intent_business_district = {'南山区': ['科技园', '白石洲', '深圳湾'], '福田区': ['上下沙', '景田', '梅林'],
                                '宝安区': ['新安', '西乡', '福永']}
...
if __name__ == '__main__':
    ...
    print(f'生成{11}条数据一共花了:{(endtime - starttime).seconds}秒')
